...
int main() {
    //int v;
    //cout << "Enter Number of Vertices in the Graph: "; cin >> v;
   

    //vector<vector<int>> graph(v, vector<int>(v));

    //cout << "Enter adjacency matrix for a graph of " << v << " vertices:" << endl;
    //// Accept the adjacency matrix input in row-wise fashion
    //for (int i = 0; i < v; i++) {
    //    cout << "Enter row " << i + 1 << ": ";u
    //    for (int j = 0; j < v; j++) {
    //        cin >> graph[i][j];
    //    }
    //}
